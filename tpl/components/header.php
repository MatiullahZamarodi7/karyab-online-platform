...
<head>
	...
	crossorigin="">
	<!-- <link rel="icon" href="/link/542689.png" type="image/x-icon"> -->
	<link rel="stylesheet" href="<?php echo links ?>/single_page.css">
	<link rel="stylesheet" href="boot code/boot.min.css">
	<link rel="stylesheet" href="<?php echo links?>/style-about.css">
	<link rel="icon" href="../links/img_of_about/karyab-logoSmall.png">
	<title>سایت کاریاب</title>
	<style>
       ...
       *{
		...
		<!-- add font here for tow pages about and contact -->
	<!-- <style>
		*{
	...
	<!-- Google tag (gtag.js) -->
	<script async="" src="<?php echo links ?>/js"></script>
	<script>
	...
	<link rel="stylesheet"
		href="<?php echo links ?>/course_category_landing.css">
	...
	<!-- Main Header Section -->
		...
		<div class="main-header" id="main-header">
			<div class="container">
				<div class="main-header__left">
					...
					<a href="" class="main-header__logo">
						...
						<!-- <img src="<?php echo links ?>/img_of_about/karyab-logoSmall.png"
							alt="Tosinso Logo" class="logo-small" width="45"> -->
					</a>
			...
			<div class="mobile-search-overlay">
				...
				<button class="close-search-btn" aria-label="Close search">×</button>
			</div>
		</div>
